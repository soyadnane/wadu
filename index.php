    ...
    <nav class="navbar navbar-expand-xl navbar-dark bg-dark">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse show" id="navbarDark">
                ...
                <a class="nav-link nav-link-lenguage active" href="./en/index.html"><img src="./assets/img/reino-unido.png" alt="ingles" width="20px"></a>
                <a class="nav-link nav-link-lenguage active" href="./ar/index.html"><img src="./assets/img/emiratos-arabes-unidos.png" alt="arabe" width="20px"></a>
                <form class="d-flex">
